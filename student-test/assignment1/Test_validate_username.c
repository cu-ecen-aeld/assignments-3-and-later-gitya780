...
void test_validate_my_username()
{
     ...
     */
	const char *str_sys=my_username();
	const char *str_input=malloc_username_from_conf_file();	
    TEST_ASSERT_EQUAL_STRING_MESSAGE(str_sys, str_input, "usernames are equal");
}
